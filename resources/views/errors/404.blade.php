...
<section class="py-20 bg-custom-bg-purple">
    <div class="container mx-auto text-center py-36">
        ...
        <a href="{{route('home')}}" class="underline hover:text-custom-button-purple hover:transition-all duration-200 text-2xl"><button class="mainbutton">Go back to homepage</button></a>
    </div> 
</section>
@endsection