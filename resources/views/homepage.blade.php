    ...
    <div class="container text-center mx-auto">
        ...
        <div class="sm:basis-full md:flex md:flex-row md:justify-center md:gap-20 ">
            ...
            <div class="mx-11 md:mx-0">
                <img src="{{url('/img/Nik_image.png')}}" alt="cirle holder" class="shrink-0  scale-75 mx-auto sm:shrink-1 sm:scale-100 md:scale-100"/>
                ...
                <div class=" mt-6 mb-6 block p-6 max-w-s bg-custom-slight-purple rounded-xl hover:shadow-xl hover:bg-custom-button-purple transition-all duration-200 delay-75">
                    <ul class="sm:text-center md:text-left">
                        ...
                        <li><i class="checker fa-solid fa-check"></i><span class="ml-2"> Graphic Design </span></li>
                        <li><i class="checker fa-solid fa-check"></i><span class="ml-2"> Illustration </span></li>
                        <li><i class="checker fa-solid fa-check"></i> <span class="ml-2"> UI/UX Design </span></li>
                        <li><i class="checker fa-solid fa-check"></i><span class="ml-2"> Motion Graphics </span></li>
                        <li><i class="checker fa-solid fa-check"></i><span class="ml-2"> Video Editing </span></li>
                        <li><i class="checker fa-solid fa-check"></i><span class="ml-2"> Basic Web Development</span></li>
                    </ul>
                </div>
            ...
            <!-- Vevien -->
            <div class="mx-11 md:mx-0">
                <img src="{{url('/img/Vien_image.png')}}" alt="cirle holder" class="shrink-0  scale-75 mx-auto sm:shrink-1 sm:scale-100 md:scale-100"/>
                ...
                <div class="mt-6 mb-6 block p-6 sm:max-w-s bg-custom-slight-purple rounded-xl hover:shadow-xl hover:bg-custom-button-purple transition-all duration-200 delay-75">
                    <ul class="text-center md:text-left">
                        <p class="text-2xl font-semibold mb-2"> Expertise </p>
                        <li><i class="checker fa-solid fa-check"></i><span class="ml-2">Digital Marketing</span></li>
                        <li><i class="checker fa-solid fa-check"></i><span class="ml-2">Search Engine Optimization</span></li>
                        <li><i class="checker fa-solid fa-check"></i> <span class="ml-2">Project Management </span></li>
                        <li><i class="checker fa-solid fa-check"></i><span class="ml-2">Analytics Reporting</span></li>
                        <li><i class="checker fa-solid fa-check"></i><span class="ml-2">KPI Tracking</span></li>
    ...
    <div class="container mx-auto py-20">
        <div class="flex flex-col mx-11 md:mx-0 lg:flex-row justify-center gap-10 align-middle">
            <div class="basis-4/12 gap-20 md:order-last lg:order-first">
                ...
                <p>We are in the same class from college with a <strong>BS in Computer Engineering.</strong> We graduated in the same year of batch 2019 from the University of Science and Technology of Southern Philippines. Now we are working on a Norway-based company that excels in Digital Marketing. 
                <br><br>Years and accomplishments have passed since we started the company, and we want to use things we learned beyond that. Nik is a designer who knows little about development, and Vevien is a <strong>Marketing Manager</strong> who leads a team of marketers.</p>
                <a href="/about"><button class="mainbutton mt-10">Read more about us</button></a>
            </div>    

            <div class="basis-4/12 gap-20 order-first">
                <img src="{{url('/img/imgplaceholder.png')}}" alt="cirle holder" class="mr-auto lg:mx-auto"/>
            </div>
             <!-- End of Half  -->
        </div>
    </div>
    ...
    <div class="container mx-auto py-20">
        <div class="flex flex-col mx-11 md:mx-0 lg:flex-row justify-center gap-10">
            <div class="basis-4/12 gap-20">
                <img src="{{url('/img/imgplaceholder.png')}}" alt="cirle holder" class="mr-auto lg:mx-auto z-0"/>
            </div>
            <div class="basis-4/12 gap-20">
