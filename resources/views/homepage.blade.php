    ...
    <div class="container text-center mx-auto">
        ...
        <div class="sm:basis-full md:flex md:flex-row md:justify-center md:gap-20 ">
            ...
            <div class="mx-11 md:mx-0">
                <img src="{{url('/img/nik image.png')}}" alt="cirle holder" class="shrink-0  scale-75 mx-auto sm:shrink-1 sm:scale-100 md:scale-100 hover:scale-105 transition-transform duration-500 delay-50 ease-in-out"/>
            ...
            <!-- Vevien -->
            <div class="mx-11 md:mx-0">
                <img src="{{url('/img/vien image.png')}}" alt="cirle holder" class="shrink-0  scale-75 mx-auto sm:shrink-1 sm:scale-100 md:scale-100 hover:scale-105 transition-transform duration-500 delay-50 ease-in-out"/>
